...
export const HeroWithAbout = (): JSX.Element => {
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div
        className="absolute -top-20 left-1/2 -translate-x-1/4 w-[600px] xl:w-[900px] 2xl:w-[1250px] h-auto xl:h-[600px] 2xl:h-[780px] pointer-events-none opacity-0 animate-fade-in [--animation-delay:400ms]"
        style={{
