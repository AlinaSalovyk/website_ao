...
export const Departments = (): JSX.Element => {
    return (
        <section className="w-full bg-layout-bg flex flex-col items-center justify-center">
            <div className="flex flex-col w-full max-w-[1440px] px-9">
                <div className="flex flex-col gap-[500px] w-full">
                    {departments.map((department, index) => (
                        <article
                            key={index}
                            className="relative w-[1350px] h-[900px] bg-cover bg-center translate-y-[2rem] animate-fade-in opacity-0"
                            style={
                                {
                        ...
                        >
                            <div className="flex w-full items-center justify-between px-0 py-3 relative top-[35px] bg-layout-bg border-t border-departments-border">
                                <div className="flex flex-col items-start">
                                    <h2 className="[font-family:'Atyp_Display-Medium',Helvetica] font-medium text-pure-white text-2xl leading-[30px] max-w-[450px]">
                                        {department.title}
                                    </h2>
                                </div>
                                    ...
                                    <ul className="flex items-center gap-6">
                                        {department.categories.map((category, catIndex) => (
                                            <li key={catIndex}>
                                                ...
                                                >
                                                    <span className="[font-family:'Atyp_Text-Medium',Helvetica] font-medium text-departments-badge text-[11.2px] tracking-[0.36px] leading-[14.4px] whitespace-nowrap">
                                                        {category}
                                                    </span>
                                                </Badge>
                                            </li>
                                ...
                                <Button
                                    variant="outline"
                                    className="h-auto rounded-full border-pure-white bg-transparent hover:bg-pure-white/10 pt-1.5 pb-1 px-[11px] transition-colors"
                                >
