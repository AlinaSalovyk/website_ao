...
// Додано, оскільки використовується в новій секції навігації
const socialIcons = [
    {
        icon: (
            <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-full">
                <mask id="mask0_530_5767_news" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="22" y="22" width="20" height="20">
                    <path d="M42 22H22V42H42V22Z" className="fill-pure-black" />
                </mask>
                <g mask="url(#mask0_530_5767_news)">
    ...
    },
    {
        icon: (
            <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-full">
                ...
                <mask id="path-3-inside-1_530_5773_news" className="fill-white">
                    <path d="M0 32C0 14.3269 14.3269 0 32 0C49.6731 0 64 14.3269 64 32C64 49.6731 49.6731 64 32 64C14.3269 64 0 49.6731 0 32Z" />
                </mask>
                <path d="M32 64V63C14.8792 63 1 49.1208 1 32H0H-1C-1 50.2254 13.7746 65 32 65V64ZM64 32H63C63 49.1208 49.1208 63 32 63V64V65C50.2254 65 65 50.2254 65 32H64ZM32 0V1C49.1208 1 63 14.8792 63 32H64H65C65 13.7746 50.2254 -1 32 -1V0ZM32 0V-1C13.7746 -1 -1 13.7746 -1 32H0H1C1 14.8792 14.8792 1 32 1V0Z" className="fill-layout-bg/20" mask="url(#path-3-inside-1_530_5773_news)" />
            </svg>
        ),
        alt: "LinkedIn",
    },
    {
        icon: (
            <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-full">
                ...
                <mask id="path-3-inside-1_530_5779_news" className="fill-white">
                    <path d="M0 32C0 14.3269 14.3269 0 32 0C49.6731 0 64 14.3269 64 32C64 49.6731 49.6731 64 32 64C14.3269 64 0 49.6731 0 32Z" />
                </mask>
                <path d="M32 64V63C14.8792 63 1 49.1208 1 32H0H-1C-1 50.2254 13.7746 65 32 65V64ZM64 32H63C63 49.1208 49.1208 63 32 63V64V65C50.2254 65 65 50.2254 65 32H64ZM32 0V1C49.1208 1 63 14.8792 63 32H64H65C65 13.7746 50.2254 -1 32 -1V0ZM32 0V-1C13.7746 -1 -1 13.7746 -1 32H0H1C1 14.8792 14.8792 1 32 1V0Z" className="fill-layout-bg/20" mask="url(#path-3-inside-1_530_5779_news)" />
            </svg>
        ),
        alt: "X (Twitter)",
    },
    {
        icon: (
            <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-full">
                <mask id="mask0_530_5785_news" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="22" y="22" width="20" height="20">
                    <path d="M42 22H22V42H42V22Z" className="fill-pure-black" />
                </mask>
                <g mask="url(#mask0_530_5785_news)">
                ...
                <mask id="path-4-inside-1_530_5785_news" className="fill-white">
                    <path d="M0 32C0 14.3269 14.3269 0 32 0C49.6731 0 64 14.3269 64 32C64 49.6731 49.6731 64 32 64C14.3269 64 0 49.6731 0 32Z" />
                </mask>
                <path d="M32 64V63C14.8792 63 1 49.1208 1 32H0H-1C-1 50.2254 13.7746 65 32 65V64ZM64 32H63C63 49.1208 49.1208 63 32 63V64V65C50.2254 65 65 50.2254 65 32H64ZM32 0V1C49.1208 1 63 14.8792 63 32H64H65C65 13.7746 50.2254 -1 32 -1V0ZM32 0V-1C13.7746 -1 -1 13.7746 -1 32H0H1C1 14.8792 14.8792 1 32 1V0Z" className="fill-layout-bg/20" mask="url(#path-4-inside-1_530_5785_news)" />
            </svg>
        ),
        alt: "YouTube",
    },
