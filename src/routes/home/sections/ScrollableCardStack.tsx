                        ...
                        >
                            ...
                            <div className="flex w-full items-center justify-between px-0 py-3 relative top-6 xl:top-8 2xl:top-[35px] bg-layout-bg border-t border-departments-border">
                                <div className="flex flex-col items-start">
                                    <h2 className="[font-family:'Atyp_Display-Medium',Helvetica] font-medium text-pure-white text-xl xl:text-2xl leading-snug xl:leading-[30px] max-w-xs xl:max-w-sm 2xl:max-w-[450px]">
                                        {item.title}
                                    </h2>
                                </div>
