      ...
      <div className="flex flex-col gap-6 w-full">
        ...
        <div className="mb-6">
          <PageGuide
            ...
            items={[
              { title: "Мовні версії (UK / EN)", desc: "Заповніть назву та контент для двох мов або скористайтеся автоматичним перекладом UK → EN." },
              { title: "Заголовок та Slug", desc: "Заголовок обов'язковий. Slug генерується з назви для гарного посилання на статтю." },
              { title: "Короткий опис", desc: "Вступний анонс новини (2-3 речення), який відображається у списках та картках." },
              { title: "Зміст (HTML)", desc: "Повний текст статті з підтримкою HTML-тегів (списки, параграфи, виділення, посилання, фото, відео)." },
              { title: "Обкладинка та Категорія", desc: "Завантажте головне фото та виберіть відповідну категорію зі списку справа." },
              { title: "Закріплена стаття", desc: "Увімкніть перемикач, щоб вивести статтю в самий верх сайту у вигляді головного банера." }
            ]}
          />
        </div>
