...
export const Footer = (): JSX.Element => {
    return (
        <section className="flex flex-col w-full items-start relative  flex-1">
            <div className="flex flex-col w-full items-center justify-center px-0 py-12 bg-footer-bg relative flex-1">
                <div className="flex flex-col max-w-7xl 2xl:max-w-screen-2xl w-full items-start justify-center px-4 py-0 relative flex-1">
                    <div className="flex flex-col items-start justify-between flex-1 w-full">
                        <div className="flex items-start justify-between flex-1 w-full gap-4 mt-4 translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:600ms]">
                            <Card className="w-[413px] bg-footer-card-deep border-none rounded-lg transition-transform duration-300">
                                <CardContent className="flex flex-col items-start gap-[247.48px] p-6">
                                    <div className="flex flex-col items-start gap-6 w-full">
                                        ...
                                        <h2 className="font-medium text-[32px] leading-[38px] text-pure-white tracking-[0]">
                                            Розвиток та <br />
                            ...
                            <Card className="flex-1 bg-footer-card-deep border-none rounded-lg overflow-hidden transition-transform duration-300">
                                <CardContent className="flex flex-col items-start gap-[220px] p-6">
                                    ...
                                    <div className="flex items-end justify-between w-full">
                                        <div className="inline-flex flex-col items-start justify-end">
                                            <h3 className="font-semibold text-pure-white text-7xl tracking-[0] leading-[80px] whitespace-nowrap">
                                                Start Studying
                                            </h3>
                                        </div>

                                        <div className="inline-flex flex-col min-w-[180px] items-end">
                                            <div className="flex flex-col w-[229px] items-end gap-[3px]">
                                                <button className="flex  justify-between w-full group cursor-pointer">
                                                    <div className="relative w-[181px] h-4">
                                                        <span className="h-4 flex text-pure-white text-xs leading-4 whitespace-nowrap font-normal tracking-[0] transition-opacity">
                                                            Контактуй з нами
                                                        </span>
                                                    </div>
                                                    <svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
