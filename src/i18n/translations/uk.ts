export const uk = {
  ...
  programTitles: {
    ...
    ai: '"Штучний інтелект та аналітика даних"',
  ...
  laboratory: {
    ...
    gallery: [
      "Робоче місце лабораторії з обладнанням",
      "Навчальне обладнання в лабораторії",
      "Технічне оснащення лабораторії",
      "Простір лабораторії для практичних занять",
      "Лабораторний стенд для виконання проєктів",
      "Навчальна зона лабораторії",
    ],
  },
  ...
  laboratoryVr: {
    ...
    gallery: [
      "VR-лабораторія: робоча зона з обладнанням",
      "VR-лабораторія: навчальний стенд",
      "VR-лабораторія: технічне обладнання",
      "VR-лабораторія: простір для практики",
      "VR-лабораторія: лабораторний стенд",
      "VR-лабораторія: навчальна зона",
    ],
  },
